...
Status: INCOMPLETE. Review of source requirements against migrations 0001–0008,
...
| B1.3 Venture | Owner scope, capital constraints, criteria | Typed Assumption/Risk links; stage lifecycle |
...
| B1.13 Workflow | Identity and immutable version reference/hash | Full definition fields and immutable step/policy/tool/KPI relationships |
| B1.14 WorkflowRun | Exact immutable version pin, scope/risk/approval | Trigger linkage semantics and state transitions |
...
Next bounded increment: close Workflow definition coverage and Venture governance
relationships, then isolate application roles and qualify their actual privileges.
